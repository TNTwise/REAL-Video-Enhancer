...
<strong>Rife ESRGAN APP Linux QT</strong>strong> Is a redesign (and hopefully an upgrade) from the original Rife ESRGAN App linux. This program provides easy access to frame interpolation and upscaling on Linux, similar to <a href="https://nmkd.itch.io/flowframes">Flowframes</a> or <a href="https://github.com/mafiosnik777/enhancr">enhancr</a> on windows.
<p align=center>
