...
def end(renderdir,videoName,videopath,times,outputpath):
        ...
        os.system(f'ffmpeg -framerate {fps*times} -i "{renderdir}/{videoName}_temp/output_frames/%08d.png" -crf 18 -c:a copy "{output_video_file}"') #ye we gonna have to add settings up in this bish
