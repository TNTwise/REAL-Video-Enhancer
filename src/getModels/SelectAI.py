...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_6.addWidget(self.RifeVSCheckBox, 12, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.CainCheckBox, 15, 0, 1, 1)
        self.RifeCUDACheckBox = QtWidgets.QCheckBox(self.InstallModelsFrame)
        self.RifeCUDACheckBox.setObjectName("RifeCUDACheckBox")
        self.gridLayout_6.addWidget(self.RifeCUDACheckBox, 11, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RifeCheckBox.setText(_translate("MainWindow", "RIFE NCNN (Interpolate General)"))
