...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_6.addWidget(self.RifeSettings, 5, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.CainCheckBox, 8, 0, 1, 1)
        self.RifeCheckBox = QtWidgets.QCheckBox(self.InstallModelsFrame)
        self.RifeCheckBox.setObjectName("RifeCheckBox")
        self.gridLayout_6.addWidget(self.RifeCheckBox, 5, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.Waifu2xCheckBox, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RealCUGANCheckBox.setText(_translate("MainWindow", "RealCUGAN (Upscale)"))
        self.CainCheckBox.setText(_translate("MainWindow", "IFRNET (Interpolate)"))
        self.RifeCheckBox.setText(_translate("MainWindow", "RIFE (Interpolate)"))
        self.RealESRGANCheckBox.setText(_translate("MainWindow", "RealESRGAN (Upscale)"))
        self.Waifu2xCheckBox.setText(_translate("MainWindow", "Waifu2X (Upscale)"))
