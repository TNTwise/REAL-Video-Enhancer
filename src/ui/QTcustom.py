...
class DownloadDepsDialog(QtWidgets.QDialog):
    ...
    # retranslateUi
class SelectModelDownloadOptionPopUp(QDialog):
    def __init__(
        self,
    ):
        super().__init__()
    ...
    def setupUi(self, MainWindow):
        ...
        self.allInterentRequiredCheckBox = QCheckBox(self.centralwidget)
        self.allInterentRequiredCheckBox.setObjectName(u"allInterentRequiredCheckBox")

        self.gridLayout.addWidget(self.allInterentRequiredCheckBox, 1, 0, 1, 1)

        self.NoInternetRequiredCheckBox = QCheckBox(self.centralwidget)
        self.NoInternetRequiredCheckBox.setObjectName(u"NoInternetRequiredCheckBox")

        self.gridLayout.addWidget(self.NoInternetRequiredCheckBox, 3, 0, 1, 1)

        self.someInternetRequiredCheckBox = QCheckBox(self.centralwidget)
        self.someInternetRequiredCheckBox.setObjectName(u"someInternetRequiredCheckBox")

        self.gridLayout.addWidget(self.someInternetRequiredCheckBox, 2, 0, 1, 1)
        ...
        self.horizontalSpacer = QSpacerItem(880, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_2.addItem(self.horizontalSpacer)

        self.doneBtn = QPushButton(self.widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.allInterentRequiredCheckBox.setText(QCoreApplication.translate("MainWindow", u"Download models when needed (Internet required for use)", None))
        self.NoInternetRequiredCheckBox.setText(QCoreApplication.translate("MainWindow", u"Download all models for all backends (Internet not required)", None))
        self.someInternetRequiredCheckBox.setText(QCoreApplication.translate("MainWindow", u"Download all models for the currently chosen backends (Internet not initially required)", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Select Model Downloading Option", None))
