...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_4.addWidget(self.qualityLabel)
        self.qualityCombo = QtWidgets.QComboBox(self.centralwidget)
        self.qualityCombo.setObjectName("qualityCombo")
        self.verticalLayout_4.addWidget(self.qualityCombo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(
            _translate(
                "MainWindow",
                '<html><head/><body><p><span style=" font-size:22pt; font-weight:700;">Enter video URL:</span></p></body></html>',
            )
        )
